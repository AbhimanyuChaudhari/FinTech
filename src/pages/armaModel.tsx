...
export default function ARMAForecastPage() {
  ...
  return (
    <div style={{ backgroundColor: "#0f172a", color: "#f1f5f9", minHeight: "100vh", padding: "2rem" }}>
      <h1 style={{ fontSize: "1.8rem", color: "#60a5fa", marginBottom: "1rem" }}>
        ARMA Model Forecast for {ticker}
      </h1>
      ...
      {loading ? (
        ...
        <>
          <p><strong>Order:</strong> AR({forecast.order.p}), MA({forecast.order.q})</p>
